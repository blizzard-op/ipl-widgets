			    			...
			    			function setSchedule(match_Obj) {
								...
								if (tag == false) {
				    				...
				    				if(gameTitle == 'league-of-legends') {
				    					(function() {
					    					if(gameEnd > now && gameStart < today) {
												$("<div class='listing'><p><span>" + gameStart.local().format('hA') + '</span> - ' + title + "</p><p class='sub'>" + subtitle_1 + "</p><p class='tags'><span class=" + tag + '>' + tag + '</span></p></div>').appendTo('#lol-today');
											} else if(gameStart > today && gameStart < tomorrow){
												$("<div class='listing'><p><span>" + gameStart.local().format('hA') + '</span> - ' + title + "</p><p class='sub'>" + subtitle_1 + "</p><p class='tags'><span class=" + tag + '>' + tag + '</span></p></div>').appendTo('#lol-tomorrow');
											} else if(gameStart > tomorrow && gameStart < day3){
												$("<div class='listing'><p><span>" + gameStart.local().format('hA') + '</span> - ' + title + "</p><p class='sub'>" + subtitle_1 + "</p><p class='tags'><span class=" + tag + '>' + tag + '</span></p></div>').appendTo('#lol-3');
											} else if(gameStart > day3 && gameStart < day4){
												$("<div class='listing'><p><span>" + gameStart.local().format('hA') + '</span> - ' + title + "</p><p class='sub'>" + subtitle_1 + "</p><p class='tags'><span class=" + tag + '>' + tag + '</span></p></div>').appendTo('#lol-4');
											} else if(gameStart > day4 && gameStart < day5){
												$("<div class='listing'><p><span>" + gameStart.local().format('hA') + '</span> - ' + title + "</p><p class='sub'>" + subtitle_1 + "</p><p class='tags'><span class=" + tag + '>' + tag + '</span></p></div>').appendTo('#lol-5');
											} else if(gameStart > day5 && gameStart < day6){
												$("<div class='listing'><p><span>" + gameStart.local().format('hA') + '</span> - ' + title + "</p><p class='sub'>" + subtitle_1 + "</p><p class='tags'><span class=" + tag + '>' + tag + '</span></p></div>').appendTo('#lol-6');
											} else if(gameStart > day6 && gameStart < day7){
												$("<div class='listing'><p><span>" + gameStart.local().format('hA') + '</span> - ' + title + "</p><p class='sub'>" + subtitle_1 + "</p><p class='tags'><span class=" + tag + '>' + tag + '</span></p></div>').appendTo('#lol-7');
											};
										})();
									} else {
										(function() {
					    					if(gameEnd > now && gameStart < today) {
												$("<div class='listing'><p><span>" + gameStart.local().format('hA') + '</span> - ' + title + "</p><p class='sub'>" + subtitle_1 + '</p><p><span class=' + tag + '>' + tag + '</span></p></div>').appendTo('#sc-today');
											} else if(gameStart > today && gameStart < tomorrow){
												$("<div class='listing'><p><span>" + gameStart.local().format('hA') + '</span> - ' + title + "</p><p class='sub'>" + subtitle_1 + '</p><p><span class=' + tag + '>' + tag + '</span></p></div>').appendTo('#sc-tomorrow');
											} else if(gameStart > tomorrow && gameStart < day3){
												$("<div class='listing'><p><span>" + gameStart.local().format('hA') + '</span> - ' + title + "</p><p class='sub'>" + subtitle_1 + '</p><p><span class=' + tag + '>' + tag + '</span></p></div>').appendTo('#sc-3');
											} else if(gameStart > day3 && gameStart < day4){
												$("<div class='listing'><p><span>" + gameStart.local().format('hA') + '</span> - ' + title + "</p><p class='sub'>" + subtitle_1 + '</p><p><span class=' + tag + '>' + tag + '</span></p></div>').appendTo('#sc-4');
											} else if(gameStart > day4 && gameStart < day5){
												$("<div class='listing'><p><span>" + gameStart.local().format('hA') + '</span> - ' + title + "</p><p class='sub'>" + subtitle_1 + '</p><p><span class=' + tag + '>' + tag + '</span></p></div>').appendTo('#sc-5');
											} else if(gameStart > day5 && gameStart < day6){
												$("<div class='listing'><p><span>" + gameStart.local().format('hA') + '</span> - ' + title + "</p><p class='sub'>" + subtitle_1 + '</p><p><span class=' + tag + '>' + tag + '</span></p></div>').appendTo('#sc-6');
											} else if(gameStart > day6 && gameStart < day7){
												$("<div class='listing'><p><span>" + gameStart.local().format('hA') + '</span> - ' + title + "</p><p class='sub'>" + subtitle_1 + '</p><p><span class=' + tag + '>' + tag + '</span></p></div>').appendTo('#sc-7');
											};
										})();
									};
